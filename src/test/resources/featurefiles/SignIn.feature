...
Feature: As a QA, I would like to verify all negative scenarios for login
  ...
  Scenario Outline: : User should not be able to login with invalid credential
    ...
    | Nolantenet         | 23434343443            | Password    |Sorry, that password isn't valid. Please include a letter.                                           |
    | Nolantenet         | tenet                  | Password    |Sorry, that password is too short. It needs to be eight characters or more.                          | 